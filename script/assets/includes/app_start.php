...
try {
    ...
    $wo['all_private_categories']   = Wo_GetPrivateCategories();
    $wo['private_categories']   = Wo_GetPrivateCategories(false);
    // END
    ...
    $wo['page_categories']   = [];
    $wo['group_categories']   = [];
    $wo['all_private_categories']   = [];
    $wo['private_categories']   = [];
    $wo['blog_categories']   = [];
...
// get private group job categories - START
Wo_GetPrivateJobCategories();
// END
