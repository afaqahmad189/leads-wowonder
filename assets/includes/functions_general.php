...
function Wo_SeoLink($query = '')
{
    ...
    if ($wo['config']['seoLink'] == 1) {
        $query = preg_replace(array(
            ...
            '/^index\.php\?link1=private-group-setting&group=([A-Za-z0-9_]+)&link3=([A-Za-z0-9_-]+)&name=([A-Za-z0-9_-]+)$/i',
            '/^index\.php\?link1=private-group-setting&group=([A-Za-z0-9_]+)&link3=([A-Za-z0-9_-]+)$/i',
            '/^index\.php\?link1=private-group-setting&group=([^\/]+)$/i',
            '/^index\.php\?link1=join-private-group&token=([A-Za-z0-9_]+)&ref=([A-Za-z0-9_-]+)$/i',
            // END
            ...
            '/^index\.php\?link1=leads$/i',
            '/^index\.php\?link1=show-lead&eid=(\d+)$/i',
            '/^index\.php\?link1=create-lead$/i',
            '/^index\.php\?link1=edit-lead&eid=(\d+)$/i',
            '/^index\.php\?link1=leads-going$/i',
            '/^index\.php\?link1=leads-invited$/i',
            '/^index\.php\?link1=leads-interested$/i',
            '/^index\.php\?link1=leads-past$/i',
            '/^index\.php\?link1=my-leads$/i',
            '/^index\.php\?link1=$/i',
            ...
            // private group links - START
            $config['site_url'] . '/private-group-setting/$1/$2?name=$3',
            $config['site_url'] . '/private-group-setting/$1/$2',
            $config['site_url'] . '/private-group-setting/$1',
            $config['site_url'] . '/join-private-group/$1/$2',
            // END
            ...
            $config['site_url'] . '/leads/',
            $config['site_url'] . '/leads/$1/',
            $config['site_url'] . '/leads/create-lead/',
            $config['site_url'] . '/leads/edit/$1/',
            $config['site_url'] . '/leads/going/',
            $config['site_url'] . '/leads/invited/',
            $config['site_url'] . '/leads/interested/',
            $config['site_url'] . '/leads/past/',
            $config['site_url'] . '/leads/my/',
            $config['site_url'] . '/leads//',
