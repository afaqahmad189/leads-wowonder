...
// private group tables - START
define('T_PRIVATE_GROUPS', 'Wo_Private_Groups');
define('T_PRIVATE_ADMINS', 'Wo_Private_GroupAdmins');
define('T_PRIVATE_MEMBERS', 'Wo_Private_Members');
define('T_PRIVATE_CATEGORY', 'Wo_Private_Categories');
define('T_PRIVATE_JOB_CATEGORY', 'Wo_Private_JobCategories');
define('T_PRIVATE_ALLOWED_CATEGORY', 'Wo_Private_AllowedCategories');
define('T_PRIVATE_INVITES', 'Wo_Private_GroupInvites');
define('T_PRIVATE_REFERRALS', 'Wo_Private_Referrals');
define('T_PRIVATE_THANKS', 'Wo_Private_Thanks');
define('T_PRIVATE_SUGGESTIONS', 'Wo_Private_Suggestions');
// END
//abdul custom sttart
define('T_PRODUCT_CATEGORY', 'Wo_Product_Category');
define('T_LEADS', 'wo_leads');
define('T_LEADS_MEMBERS', 'wo_lead_members');
//end