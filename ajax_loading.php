    ...
    if ($wo['loggedin'] == true) {
        if ($wo['user']['is_pro'] != 0 || Wo_IsAdmin()) {
            switch ($page) {
                ...
                case 'private-groups':
                    ...
                    break;
                case 'private-group':
                    include('sources/private_group.php');
                    break;
                case 'create-private-group':
                    include('sources/create_private_group.php');
                    break;
                case 'private-group-setting':
                    include('sources/private_group_setting.php');
                    break;
        ...
        switch ($page) {
            ...
            case 'terms':
                ...
                break;
            case 'create-lead':
                include('sources/leads/create_lead.php');
                break;
            case 'edit-lead':
                include('sources/leads/edit_lead.php');
                break;
            case 'leads':
                include('sources/leads/leads_upcomming.php');
                break;
            case 'leads-going':
                include('sources/leads/leads_going.php');
                break;
            case 'leads-interested':
                include('sources/leads/leads_interested.php');
                break;
            case 'leads-past':
                include('sources/leads/leads_past.php');
                break;
            case 'show-lead':
                include('sources/leads/show_lead.php');
                break;
            case 'leads-invited':
                include('sources/leads/leads_invited.php');
                break;
            case 'my-leads':
                include('sources/leads/my_leads.php');
                break;
            case '':
                include('sources/leads/lead-details.php');
                break;
...
//                    abdul custom start
        ...
        case 'leads-received-bid':
            ...
            break;
        case 'leads-created':
            include('sources/private_lead/leads_created.php');
            break;
        ...
        case 'brows-hot-leads':
            ...
            break;
        case 'leads-packages':
            include('sources/private_lead/leads_packages.php');
            break;
//                    end
