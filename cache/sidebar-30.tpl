<div class="sidebar-conatnier">
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="http://indmonk.com/upload/photos/d-cover.jpg?cache=0" alt="prasanth Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-30" alt="prasanth Profile Picture" src="http://indmonk.com/upload/photos/d-avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=prasanth" href="http://indmonk.com/prasanth">prasanth</a>
					<p>@prasanth</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="http://indmonk.com/prasanth" data-ajax="?link1=timeline&u=prasanth">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="http://indmonk.com/prasanth/following" data-ajax="?link1=timeline&u=prasanth&type=following">
							<span class="split-link"><b>Following</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="http://indmonk.com/prasanth/followers" data-ajax="?link1=timeline&u=prasanth&type=followers">
		...
		<ul class="list-group trending">
            <li class="list-group-item sidebar-title-back" contenteditable="false">Trending !</li>
					...
					<a href="http://indmonk.com/hashtag/best" data-ajax="?link1=hashtag&hash=best">
						...
						<span class="htag_bottom">1 posts</span>
            				...
            				<li class="list-group-item wow_htag" dir="auto">
					<a href="http://indmonk.com/hashtag/nike" data-ajax="?link1=hashtag&hash=nike">
						<span class="htag_top"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z" /></svg> #nike</span>
						<span class="htag_bottom">1 posts</span>
					</a>
				</li>
            				<li class="list-group-item wow_htag" dir="auto">
					<a href="http://indmonk.com/hashtag/live" data-ajax="?link1=hashtag&hash=live">
						<span class="htag_top"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z" /></svg> #live</span>
						<span class="htag_bottom">1 posts</span>
					</a>
				</li>
            				<li class="list-group-item wow_htag" dir="auto">
					<a href="http://indmonk.com/hashtag/shoes" data-ajax="?link1=hashtag&hash=shoes">
						<span class="htag_top"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z" /></svg> #shoes</span>
						<span class="htag_bottom">1 posts</span>
					</a>
				</li>
			...
			<li class="list-group-item sidebar-title-back" contenteditable="false">
									<a class="pro-me-here pull-right" href="http://indmonk.com/go-pro">Put Me Here</a>
								Pro Members			</li>
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="http://indmonk.com/upload/photos/d-avatar.jpg?cache=0" alt="solo123 Profile Picture"/>
		</div>
		<span class="user-popover" data-id="3" data-type="user">
			<a href="http://indmonk.com/solo123" data-ajax="?link1=timeline&u=solo123" class="wo_user_link_name">
				<span class="user-name" title="solo123">solo123</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-3">
    <button type="button" onclick="Wo_RegisterFollow(3, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="http://indmonk.com/upload/photos/f-avatar.jpg?cache=0" alt="new user 1 Profile Picture"/>
		</div>
		<span class="user-popover" data-id="14" data-type="user">
			<a href="http://indmonk.com/newuser1" data-ajax="?link1=timeline&u=newuser1" class="wo_user_link_name">
				<span class="user-name" title="new user 1">new user 1</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-14">
    <button type="button" onclick="Wo_RegisterFollow(14, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="http://indmonk.com/upload/photos/d-avatar.jpg?cache=0" alt="Abdul Saboor Profile Picture"/>
		</div>
		<span class="user-popover" data-id="31" data-type="user">
			<a href="http://indmonk.com/saboor" data-ajax="?link1=timeline&u=saboor" class="wo_user_link_name">
				<span class="user-name" title="Abdul Saboor">Abdul Saboor</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-31">
    <button type="button" onclick="Wo_RegisterFollow(31, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="http://indmonk.com/upload/photos/f-avatar.jpg?cache=0" alt="zx1314 Profile Picture"/>
		</div>
		<span class="user-popover" data-id="28" data-type="user">
			<a href="http://indmonk.com/zx1314" data-ajax="?link1=timeline&u=zx1314" class="wo_user_link_name">
				<span class="user-name" title="zx1314">zx1314</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-28">
    <button type="button" onclick="Wo_RegisterFollow(28, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       ...
       <span class="button-text"> Follow</span>
            ...
            <li class="list-group-item text-muted sidebar-title-back" contenteditable="false">Suggested groups				<span onclick="Wo_ReloadSideBarGroups();" class="pull-right  refresh">
                <i class="fa fa-repeat progress-icon" data-icon="repeat"></i>
                </span>
            </li>
            <li>
	...
	<div class="wow_content wow_my_groups">
		<div class="avatar">
			<a href="http://indmonk.com/testprivateone" data-ajax="?link1=timeline&u=testprivateone">
				<img src="http://indmonk.com/upload/photos/d-group.jpg " alt="testprivateone Profile Picture" />
			</a>
		</div>
		<div class="wow_my_groups_info">
			<h3 class="page_title"><a href="http://indmonk.com/testprivateone" data-ajax="?link1=timeline&u=testprivateone">testprivateone</a></h3>
			<p>1 Members</p>
			<span id="join-3">
    <button type="button" onclick="Wo_RegisterGroupJoin(3, 1)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
	...
	<div class="wow_content wow_my_groups">
		<div class="avatar">
			<a href="http://indmonk.com/testgroup" data-ajax="?link1=timeline&u=testgroup">
				<img src="http://indmonk.com/upload/photos/d-group.jpg " alt="testgroup Profile Picture" />
			</a>
		</div>
		<div class="wow_my_groups_info">
			<h3 class="page_title"><a href="http://indmonk.com/testgroup" data-ajax="?link1=timeline&u=testgroup">testgroup</a></h3>
			<p>1 Members</p>
			<span id="join-1">
    <button type="button" onclick="Wo_RegisterGroupJoin(1, 1)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
       <span class="button-text"> Join</span>
    </button>
</span>		</div>
	...
	<div class="wow_content wow_my_groups">
		<div class="avatar">
			<a href="http://indmonk.com/testgroup2" data-ajax="?link1=timeline&u=testgroup2">
				<img src="http://indmonk.com/upload/photos/d-group.jpg " alt="testgroup2 Profile Picture" />
			</a>
		</div>
		<div class="wow_my_groups_info">
			<h3 class="page_title"><a href="http://indmonk.com/testgroup2" data-ajax="?link1=timeline&u=testgroup2">testgroup2</a></h3>
			<p>4 Members</p>
			<span id="join-4">
    <button type="button" onclick="Wo_RegisterGroupJoin(4, 1)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
       <span class="button-text"> Join</span>
    </button>
</span>		</div>
	...
	<div class="wow_content wow_my_groups">
		<div class="avatar">
			<a href="http://indmonk.com/Web_developerbfkdk" data-ajax="?link1=timeline&u=Web_developerbfkdk">
				<img src="http://indmonk.com/upload/photos/d-group.jpg " alt="Developerdncnc Profile Picture" />
			</a>
		</div>
		<div class="wow_my_groups_info">
			<h3 class="page_title"><a href="http://indmonk.com/Web_developerbfkdk" data-ajax="?link1=timeline&u=Web_developerbfkdk">Developerdncnc</a></h3>
			<p>1 Members</p>
			<span id="join-8">
    <button type="button" onclick="Wo_RegisterGroupJoin(8, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
       <span class="button-text"> Join</span>
    </button>
</span>		</div>
                ...
                <div class="clear"></div>
                        ...
                        <ul class="list-group">
                        <li class="list-group-item sidebar-title-back" contenteditable="false">Online Users 1</li>
            <li>
                <div class="clear"></div>
            </li>
        </ul>
			...
			<div class="wow_side_invite">
                ...
                <div id="sidebar-latest-products" class="sidebar-latest-products">
                        <ul class="list-group">
                <li class="list-group-item text-muted sidebar-title-back" contenteditable="false"><a href="http://indmonk.com/products">Latest Products</a></li>
	...
	<div class="footer-wrapper-sidebar">
		...
		<ul class="list-inline">
			<li><a data-ajax="?link1=terms&type=about-us" href="http://indmonk.com/terms/about-us">About</a></li>
							<li><a href="http://indmonk.com/blogs">Blog</a></li>
						<li><a data-ajax="?link1=contact-us" href="http://indmonk.com/contact-us">Contact Us</a></li>
							<li><a data-ajax="?link1=developers" href="http://indmonk.com/developers">Developers</a></li>
						<li>
				<div class="dropdown dropup sun_foot_drop_menu">
					...
					<ul class="dropdown-menu dropdown-menu-right" role="menu">
						<li><a data-ajax="?link1=terms&type=privacy-policy" href="http://indmonk.com/terms/privacy-policy">Privacy Policy</a></li>
						<li><a data-ajax="?link1=terms&type=terms" href="http://indmonk.com/terms/terms">Terms of Use</a></li>
													<li><a data-ajax="?link1=terms&type=refund" href="http://indmonk.com/terms/refund">Request refund</a></li>
																	</ul>
				</div>
			</li> 
		</ul>
