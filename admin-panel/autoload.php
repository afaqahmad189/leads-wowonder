...
$pages = array(
    ...
    'send_email',
    'live',
    // private group links - START
    'private-groups-categories',
    'manage-private-groups',
    'private-groups-setting',
    'private-job-categories',
    'private-job-category-suggestions',
    // END
    // abdul custom start
...
$mod_pages[] =  'manage-private-groups';
// END
...
$lead_new_count = $db->where('status',0)->getValue('wo_leads','count(id)');
?>
<!DOCTYPE html>
<html>
                ...
                <ul class="list">
                    ...
                    <li <?php echo ($page == 'manage-users'|| $page=='manage_subadmin'|| $page == 'manage-stories' || $page == 'manage-profile-fields' || $page == 'add-new-profile-field' || $page == 'edit-profile-field' || $page == 'manage-verification-reqeusts' || $page == 'affiliates-settings' || $page == 'payment-reqeuests' || $page == 'referrals-list' || $page == 'online-users' || $page == 'manage-genders') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'manage_subadmin') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('manage_subadmin'); ?>">Manage Sub-Admin</a>
                            </li>
                    ...
                    <li <?php echo ($page == 'manage-product-category' || $page == 'add-product-category' || $page == 'edit-product-category') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'add-product-category') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('add-product-category'); ?>">Add New Product Category</a>
                            </li>
                            <li <?php echo ($page == 'manage-product-category') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('manage-product-category'); ?>">Manage Product Category</a>
                            </li>
                        </ul>
                    </li>
                    <?php if ($is_admin == true) { ?>
                    ...
                    <li <?php echo ($page == 'manage-apps' || $page == 'manage-pages' || $page == 'manage-stickers' || $page == 'add-new-sticker' || $page == 'manage-gifts' || $page == 'add-new-gift' || $page == 'manage-groups' || $page == 'manage-posts' || $page == 'manage-articles' || $page == 'manage-events' ||  $page == 'manage-forum-sections' || $page == 'manage-forum-forums' || $page == 'manage-forum-threads' || $page == 'manage-forum-messages' || $page == 'create-new-forum' || $page == 'create-new-section' || $page == 'manage-movies' || $page == 'add-new-movies' || $page == 'manage-games' || $page == 'add-new-game' || $page == 'edit-movie' || $page == 'pages-categories' || $page == 'pages-sub-categories' || $page == 'groups-sub-categories' || $page == 'products-sub-categories' || $page == 'groups-categories' || $page == 'blogs-categories' || $page == 'products-categories' || $page == 'manage-fund' || $page == 'manage-jobs' || $page == 'manage-offers' || $page == 'pages-fields' || $page == 'groups-fields' || $page == 'products-fields' || in_array($page, array('manage-private-groups', 'private-groups-setting', 'private-job-categories', 'private-job-category-suggestions', 'private-groups-categories'))) ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <!-- Link for private groups - START -->
                            <li <?php echo ($page == 'manage-private-groups' || $page == 'private-groups-setting' || $page == 'private-job-category-suggestions') ? 'class="active"' : ''; ?>>
                                <a href="javascript:void(0);" class="menu-toggle">Private Groups</a>
                                <ul class="ml-menu">
                                    <li <?php echo ($page == 'manage-private-groups') ? 'class="active"' : ''; ?>>
                                        <a href="<?php echo Wo_LoadAdminLinkSettings('manage-private-groups'); ?>">
                                            <span>Manage Private Groups</span>
                                        </a>
                                    </li>

                                    <?php if ($is_admin == true) { ?>
                                        <li <?php echo ($page == 'private-groups-setting') ? 'class="active"' : ''; ?>>
                                            <a href="<?php echo Wo_LoadAdminLinkSettings('private-groups-setting'); ?>">
                                                <span>Private Groups Setting</span>
                                            </a>
                                        </li>
                                    <?php } ?>

                                    <li <?php echo ($page == 'private-job-category-suggestions') ? 'class="active"' : ''; ?>>
                                        <a href="<?php echo Wo_LoadAdminLinkSettings('private-job-category-suggestions'); ?>">
                                            <span>Private Job Categories Suggestions</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <!-- private group categories link at the end -->
                            <li <?php echo ($page == 'pages-categories' || $page == 'pages-sub-categories' || $page == 'groups-sub-categories' || $page == 'products-sub-categories' || $page == 'groups-categories' || $page == 'blogs-categories' || $page == 'products-categories' || $page == 'private-job-categories' || $page == 'private-groups-categories') ? 'class="active"' : ''; ?>>
                                ...
                                <ul class="ml-menu">
                                    ...
                                    <!-- private group categories - START -->
                                    <li <?php echo ($page == 'private-groups-categories') ? 'class="active"' : ''; ?>>
                                        <a href="<?php echo Wo_LoadAdminLinkSettings('private-groups-categories'); ?>">
                                            <span>Private Groups Categories</span>
                                        </a>
                                    </li>
                                    <li <?php echo ($page == 'private-job-categories') ? 'class="active"' : ''; ?>>
                                        <a href="<?php echo Wo_LoadAdminLinkSettings('private-job-categories'); ?>">
                                            <span>Private Groups Job Categories</span>
                                        </a>
                                    </li>
                                    <!-- END -->
